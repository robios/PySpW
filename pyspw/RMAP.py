...
def calc_crc(crc, data):
	...
	"""
	if crc == CRC_DraftE:
		table = RMAP_CRCTable_DraftE
	elif crc == CRC_DraftF:
		table = RMAP_CRCTable_DraftF
	else:
		return 0x00
...
# RMAP CRC Table
RMAP_CRCTable_DraftF = ( 0x00, 0x91, 0xe3, 0x72, 0x07, 0x96,
...
RMAP_CRCTable_DraftE = ( 0x00, 0x07, 0x0e, 0x09, 0x1c, 0x1b,
